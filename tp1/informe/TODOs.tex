...
\newcommand{\unresolved}[0]{{\textcolor{Bittersweet}{$\chi$}}}
...
\begin{itemize}
\item Eliminar idea de en q sector esta cada cosa (del alcance) \tick
\item el sistema no registra cobros (del alcance) \tick
...
\item si cajero queda automatico, sacarlo de CU
\item Agregar actor sistema bancario en el diagrama de CU
\item Agregar caso de uso Agregando insumos reutilizables vinculado a Maestro
\item Agregar caso de uso Cerrando cuenta mesa vinculado a Mozo (tener en cuenta que lo hace desde la PDA y pregunta como va a pagar)
\item Consultar si deberiamos sacar el CU Modificando politica de horno
\end{itemize}
}
\end{document}
