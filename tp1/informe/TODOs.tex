...
\item arreglar el tema de la factura en caso contingencia \tick
...
\item Agregar actor sistema bancario en el diagrama de CU \tick
\item Agregar caso de uso Agregando insumos reutilizables vinculado a Maestro \tick
\item Agregar caso de uso Cerrando cuenta mesa vinculado a Mozo (tener en cuenta que lo hace desde la PDA y pregunta como va a pagar) \tick
\item Consultar si deberiamos sacar el CU Modificando politica de horno \unresolved
\item cu de contingencia (diagrama aparte) \tick
\end{itemize}
}
\end{document}
