...
Durante una caida del sistema, la pizzería puede seguir funcionando manualmente. Luego de que el sistema se levanta, el encargado de pedidos podrá ingresar los pedidos tomados durante la caida de sistema.  %TODO: super consulta
...
Para cancelar un pedido via telefonica el usuario debe identificarse, y luego debe indicar que pedido quiere cancelar. En caso de un pedido hecho en el local, el cliente debe avisar al mozo, que notifica al encargado de pedidos, quien cancela el pedido.
...
%El primer elemento de la cola se considera lo proximo que el maestro debe preparar. El sistema muestra este pedido al maestro para que lo prepare. Cuando este lo preparó completamente, se lo indica al sistema el cual muestra el proximo pedido en caso de que halla. Si no lo habia, en cuanto llegue uno se lo muestra al maestro.
