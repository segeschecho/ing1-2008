...
Durante una caida del sistema, la pizzería puede seguir funcionando manualmente. 
...
El archivo se genera cuando un pedido esta listo para salir a entrega en el caso de que el mismo sea con delivery o en el momento en el que el cliente pide la cuenta al mozo. %TODO: caso de uso
...
Dado que no se informa cada producto que se prepara, por ejemplo si hay que hacer 6 empanadas el maestro no notifica cada vez que arma una, podria ocurrir que el pedido se cancele mientras esta siendo preparado. En este caso el sistema muestra al maestro un mensaje informandole que el pedido se cancelo, y pidiendole que indique que parte de los insumos se puede reutilizar.
...
El primer elemento de la cola se considera lo proximo que el maestro debe preparar. El elemento que esta en esta posición no puede ser movido por el encargado de pedidos. El sistema muestra este pedido al maestro para que lo prepare. Cuando este lo preparó completamente, se lo indica al sistema el cual muestra el proximo pedido en caso de que halla. Si no lo habia, en cuanto llegue uno se lo muestra al maestro.
