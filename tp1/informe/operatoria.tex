...
A continuación detalleremos los distintos tipos de pedidos
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{diagramaActividadTelefono}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{diagramaActividadWeb}
\caption{Diagrama de actividad del ingreso de un pedido telefonico}
\end{figure}
...
%TODO:calculo de tiempo estimado
...
%TODO: ojo tener en cuenta lo de despachado, que significa que el pedido salio en delivery o q el mozo se lo llevo o q el cliente se lo llevo!.
\subsection{Pedido simple}
\subsection{Pedido Mixto}
