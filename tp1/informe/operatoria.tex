...
\begin{figure}[H]
\centering
\includegraphics[height=15cm]{./figuras/PedidoPreparado.png}
\caption{Diagrama de actividad de la operación que se desecadena cuando el Maestro Pizzero indica que terminó de preparar un pedido}
\end{figure}
