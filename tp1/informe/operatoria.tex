...
todas ellas comenznado con un valor arbitrario en dicho rango,
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{./figuras/chequeoStock}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{figuras/actividadProxPedido.png}
\caption{Diagrama de actividad al informar productos cocinados}
\end{figure}

%FSM comportamiento del cocinero
...
En estas FSM utilizamos la variable, $stock : [0..MAX]$ que comienza inicializada en un valor arbitrario del rango.
Por otro lado $critico$ puede considerarse una constante al igual que $n$.
