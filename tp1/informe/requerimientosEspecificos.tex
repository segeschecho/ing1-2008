...
\cu{Cancelando pedido}{Encargado de pedido}{$\infty$}{TRUE}{Pedido cancelado}{Cancelación de un pedido} %TODO: deberia ser un requerimiento cancelar pedido
...
%TODO: VERIFICAR
\op{1. El cajero solicita una factura al sistema}{}
\op{2. El sistema envia un mensaje al sistema de facturacion solicitandole que imprima una factura}{}
\op{3. El sistema de facturacion registra el cobro e imprime una factura}{}
\op{4. El sistema de facturacion avisa al cajero que la factura esta preparada}{}
\op{5. Fin caso de uso}{}
\cu{Requiriendo facturar}{Cajero, Sistema de Facturacion}{Requerimiento 6, Requerimiento 29}{Cobro registrado}{Factura impresa}{La factura se imprimira y quedara a disposicion del cajero}
