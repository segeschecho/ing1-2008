...
\op{5. Si el pedido es posible, se informa al cliente}{4. Si el pedido no
era posible de tomar, se muestra mensaje de error al cliente indicando que productos no estan disponibles}
\op{6. Se pregunta al cliente si desea pagar con tarjeta de credito o pagar en efectivo al delivery}{}
...
%TODO: 14 es REQ?
\cu{Notificando stock cr'itico}{Encargado de stock}{14, 19}{Alg'un kit o insumo est'a por debajo del nivel cr'itico}{Surge una advertencia de stock cr'itico}{En caso de que el stock de algun producto quede por debajo de un nivel cr'itico, el sistema avisar'a al encargado de stock de esta situaci'on}
...
\cu{Haciendo ABM de stock}{Encargado de stock}{14, 15, 16, 18, 20, 22, 24}{TRUE}{El stock queda actualizado con las modificaciones}{Se puede hacer alta, baja y modificaci'on de insumos y kits comprados o caducados}
