...
Entonces consideremos el caso de un pedido ingresado. Al cancelarse todo su stock se puede reutilizar, de modo que la reposicion es completa. Veamos el diagrama de secuencias:

\begin{figure}[H]
\centering
\includegraphics[height=9cm]{./figuras/repositorPedidoIngresado.png}
\caption{Reponer stock de pedido ingresado}
\end{figure}

primero vemos que el estado sea ingresado y entonces procedemos a reponer todo el stock de sus productos.

Si el pedido se estaba preparando, hay que preguntar que hacer con los productos que son preparables, es decir pedir que insumos reponer y cuales ya fueron usados.

\begin{figure}[H]
\centering
\includegraphics[height=9cm]{./figuras/repositorPedidoEnPreparacion.png}
\caption{Reponer stock de pedido en preparacion}
\end{figure}

Finalmente si el pedido ya esta totalmente preparado, la especificación pide que solo se restablezca el stock de las bebidas. Eso es precisamente lo que se muestra en este diagrama:

\begin{figure}[H]
\centering
\includegraphics[height=9cm]{./figuras/repositorPedidoNoIngresadoNiPreparacion.png}
