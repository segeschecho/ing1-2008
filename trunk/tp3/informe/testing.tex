...
Al utilizar la GUI de nuestra aplicación, PedidoMostrador(Cliente,productos,formaDePago) debe interpretarse como ir a la pesataña de cola de ingreso, click en ingresar nuevo pedido, elegir orgien mostrador, selecionar la forma de pago $formaDePago$, el cliente $Cliente$ de la lista (o no elegir a ninguno si se desea un cliente None) y elegir los productos de la lista de productos.
...
El problema de este método es que puede generar errores en este archivo que despues generen inconsistencias.
