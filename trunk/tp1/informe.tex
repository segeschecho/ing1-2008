...
\newcommand{\op}[2]
{
\oplist=\expandafter{\the\oplist\thePasoCu #1 &\thePasoCu #2\\}
\stepcounter{PasoCu}
}
...
\hline
\multicolumn{1}{|>{\columncolor{light-gray}}p{5cm}|}{\negrita{Actores intervinientes:}} &
\multicolumn{1}{|l|}{#2}\\
\hline
\multicolumn{1}{|>{\columncolor{light-gray}}p{5cm}|}{\negrita{Requerimientos relacionados:}} &
\multicolumn{1}{|l|}{#3}\\
\hline
\multicolumn{1}{|>{\columncolor{light-gray}}p{5cm}|}{\negrita{Precondicion:}} &
\multicolumn{1}{|l|}{#4}\\
