...
\begin{figure}[H]
\centering
\includegraphics[height=11cm]{./figuras/terminarPreparacionPizza.png}
\caption{}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[height=11cm]{./figuras/terminarPreparacionPizzaYColaPizzeraVacia.png}
\caption{}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[height=13cm]{./figuras/llegaCocinarYNoseEncola.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[height=18cm]{./figuras/saleUnPedidoAgilNoTermina.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[height=18cm]{./figuras/finDeCoccion.png}
\end{figure}