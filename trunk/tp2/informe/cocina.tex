...
- gestion:
  + coordinador de cocina (façade) - describir interaccion con ingreso

- horno
  + despachador de cocción
  + horno (datos)
  + controlador (estado actual del horno)
  + fraccionador (sabe "cortar" pedidos) - todas estas divisiones son segun SRP
  + politica de cola (segun strategy)

- preparacion
  + despachador de preparacion (abstracto, según strategy y DIP)
  + preparador utiliza callback para reducir acoplamiento y está implementado de forma abstracta (según OCP y DIP)
    -> comentar la flexibilidad que da, y las caracteristicas de preparador especializado
