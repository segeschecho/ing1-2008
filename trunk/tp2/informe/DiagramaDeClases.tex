...
\begin{figure}[H]
\centering
\includegraphics[height=8cm]{./figuras/remotoBebidas.png}
...
\subsubsection{verificar stock}
\begin{itemize}
\item verifico stock y todo bien
\item verifico stock y hay q notificar critico pero todo bien
\item verifico stock algo no alcanza
\end{itemize}
