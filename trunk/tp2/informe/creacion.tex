...
El Asignador de hornos es el que decide en que horno ubicar al pedido. La asignación especificada en el tp1 es realizada por el el Asignador Standard. El criterio a seguir
es que los pedidos simples tienen su horno por defecto mientras que para los pedidos mixtos
debe preguntar al encargado que horno se asigna. La clase Asignador de Horno es abstracta porque potencialmente se podría modifcar la forma de asignar con el fin de balancear la carga, lograr un tiempo de demora ponderada menor, establecer prioridades para ciertos pedidos, entre otras cosas.
...
\begin{figure}[H]
\centering
\includegraphics[height=17cm]{./figuras/crearMostrador.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=9cm]{./figuras/estimadorDeTiempos.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=9cm]{./figuras/AsignadorDeHornoStandard.png}
