...
Luego se genera un ID para el pedido y se lo crea. Una vez creado el pedido, este pasa al asignador de horno que establece que horno le corresponde al pedido (en caso de que corresponda). Luego se procede a realizar la estimación de tiempos de cocción y el calculo del precio. Finalmente el pedido queda ingresado
