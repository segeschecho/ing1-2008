...
este componenente contiene
- el façade principal (segun patron façade)
- agrupa controladores de estados "menores" que no merecen ser separados
  $->$ estos estan uno por clase por SRP
