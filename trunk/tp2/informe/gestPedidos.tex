...
Algunas veces la sintaxis del diagrama no se ajusta del todo a la vista en clase, por ejemplo en el caso de las variables locales a un loop, esto se debe en parte a las limitaciones de la herramienta utilizada para realizar los diagramas (Quick Sequence Diagram Editor) y en parte a que algunas cuestiones de sintaxis, como la antes mencionada, no son propias de UML. No se utilizó otra herramienta diferente debido principalmente, a que esta herramienta permite escribir el codigo de los diagramas en vez de arrastrar componentes, lo cual hace mas rapida la corrección y modificación de los diagramas.

Esta aclaración vale en general para todos los diagramas del presente documento.
