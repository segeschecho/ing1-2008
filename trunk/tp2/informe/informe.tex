...
\grupo{Grupo 5}
\resumen{
Se presenta en este trabajo un modelado completo de la solución propuesta para el proyecto de software de
administración de pizzería. En el mismo se muestra el modelo de clases propuesto, asi como también diagramas de secuencia y pseudocodigos con el fin de explicar las interacciones entre las clases para lograr satisfacer los requerimientos de la pizzeria}
